...
% SEPARADOR DE LISTA
%------------------------------------------------------------------------------
% Una barra suelta al inicio de una linea se lee como un error de copiado. El
% ~ ata la barra a la palabra anterior, asi que el salto nunca cae antes de
% ella; el espacio posterior si permite cortar. Usar en listas separadas por
% barras que puedan ocupar mas de un renglon.
...
% Decia "University of Pittsburgh | Remote | 2022 -- 2025". El certificado dice
% otra cosa: curso "Computer Vision - Artificial Intelligence" del Winter School
% 2025 de la Escuela de Ingenieria de Software y Ciencias de la Computacion de
% la UPC, dictado por un profesor de Pittsburgh, del 21 al 25 de julio de 2025.
% Cinco dias, no tres anhos, y organizado por la UPC, no por Pittsburgh.
\entry
{Computer Vision --- Artificial Intelligence}
{UPC Winter School, with the University of Pittsburgh \textbar{} July 2025}

Five-day intensive taught by Nils Murrugarra-Llerena, of Pittsburgh's School of
Computing and Information. Where the FruitGuard classifier was built.
...
% Tres certificados con nombre, los mismos que src/data/education.ts, mas el
% enlace a la lista completa en LinkedIn. Se usa \sep y no \textbar{}: con
% cuatro items la linea ocupa mas de un renglon, y sin el ~ la barra quedaba
% huerfana al inicio de la ultima linea.
\skillrow{Certifications}
{Scrum Fundamentals Certified (SFC), SCRUMstudy, 2023%
\sep Introduction to MongoDB, 2023%
\sep Pixel Art for Video Games, Michigan State University via Coursera, 2024%
\sep \urlref{https://www.linkedin.com/in/gabriel-reyna-alvarado/details/certifications/}{LinkedIn Certifications}}
