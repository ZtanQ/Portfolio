...
export const projects: readonly Project[] = [
  {
    ...
    decisions: [
      ...
      "The entire dataset is synthetic, generated from aggregate statistics. Patient confidentiality was a non-negotiable constraint.",
    ],
    results: [
  ...
  },
  {
    ...
    decisions: [
      ...
      "Validated representativeness against UNEP's Food Waste Index Report 2024.",
    ],
    results: [
  ...
  },
  {
    ...
    decisions: [
      ...
      "The dataset's folder names were corrupted (`patato`, `tamto`). I normalized them at load time rather than after, so the label encoder saw clean classes from the start.",
