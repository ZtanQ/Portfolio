 ...
 *
 * The portrait takes the right-hand column, which until now was the empty
 * margin beside the prose. It comes after the text in source order so that on
 * a phone, where the grid collapses, it lands below the two actions instead of
 * pushing them under the fold.
 */
export function Hero() {
  return (
    <section className="pt-16 pb-14 md:pt-24 md:pb-20 grid grid-cols-1 md:grid-cols-[1fr_auto] gap-x-12 gap-y-10 md:items-end">
      <div>
      ...
      <div className="w-[13rem] sm:w-[15rem] md:w-[17rem] md:justify-self-end">
        <div className="relative aspect-[3/4] overflow-hidden rounded-image border border-rule bg-rule/20">
          <Image
            src="/img/gabriel-reyna-hero.jpg"
            alt="Gabriel Reyna on garden steps, in a white shirt and tie with a jacket over one shoulder."
            fill
